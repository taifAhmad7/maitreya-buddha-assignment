...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`flex flex-col justify-center h-screen w-[600px] px-4 ${
          showSidebar ? '' : 'mr-[-600px]'
        } transition-all duration-150 ease-in`}
      >
        <div>
          <div className="mb-8">
            <h2 className="text-3xl uppercase text-gray-600">
      ...
      <button
        className={`left-3 top-3  fixed rounded-full h-10 w-10 text-2xl border-2 border-gray-300 w-11 h-11 hover:scale-110 transition-all ${
          showSidebar
